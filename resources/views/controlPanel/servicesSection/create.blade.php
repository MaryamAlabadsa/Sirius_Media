        ...
        <div class="card-body">
            <form method="POST" action="{{ route('services.store') }}" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea id="title_en" name="title"
                            class="form-control">{{ old('title', $sliderData[0] ?? '') }}</textarea>
                        @error('title')
                ...
                {{-- Start sub title ar --}}
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label" for="description_ar">Sub Title Arabic</label>
                    <div class="col-sm-10">
                        <textarea id="description_ar" name="description_ar"
                            class="form-control">{{ old('description_ar', $sliderData[3] ?? '') }}</textarea>
