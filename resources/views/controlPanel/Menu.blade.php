<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item active">
            <a href="/controlPanel/sliderSection" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Dashboard</div>
            </a>
        </li>
        <li class="menu-item active">
            <a href="/controlPanel/aboutSection" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">why us section / about section</div>
            </a>
        </li>
        <li class="menu-item active">
            <a href="/controlPanel/noteSection" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
